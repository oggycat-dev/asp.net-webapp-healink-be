# Run Healink API with Environment Variables
Write-Host "=== Starting Healink API with Environment Configuration ===" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== Starting Healink API Application ===" -ForegroundColor Yellow
Write-Host ""
